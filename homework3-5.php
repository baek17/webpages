...
<body>
	<div class="action">
		<a href="?date='.$prevDate.'">이전 달</a>
		<strong>'.$date.'</strong>
		<a href="?date='.$nextDate.'">다음 달</a>
	</div>
	<table>
		<tr>
			<th>일</th>
